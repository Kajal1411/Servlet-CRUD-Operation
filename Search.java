...
public class Search extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException
	{
		...
		try
		{
			...
			ResultSet RS=st.executeQuery("select * from servletCRUD where rollno="+r);
			
			out.print("<br><br>");
			out.print("<table border='2px solid black' style='margin-left:26%'>");
			...
			out.print("</table>");
			out.print("<br>");
	        out.print("<a href='first.html'><button type='button' style='background-color:gray; color:white; margin-left:26%'>Back</button></a>");
		}
